import { type IGeometry, type GeometryType, type IFeature, type IPopupInfo, type IItem, type SpatialRelationship, type Units, type IFeatureLayer, type ILayerDefinition } from '@esri/arcgis-rest-types'
import { type IAttachmentInfo } from '@esri/arcgis-rest-feature-layer'
// only used as types
import { type DataSourceManager, type IMDataSourceJson, type IMDataSourceSchema, type IMReversedDataSourceSchema, type IntlShape, type IMDataSourceInfo, type ServiceDefinition, type ImmutableObject, type ImmutableArray, type SqlExpression } from 'jimu-core'
// only used as types
...
export interface SqlQueryParams extends QueryParams {
   ...
   *
   * When merging one data view's query params and main data source's query params, will check whehter their `isCaseSensitive` are the same.
...
export interface DataSource {
  ...
  type: string
  /** The data source manager, which is to manage data source, including create/get/destroy data source instance. */
  dataSourceManager: DataSourceManager
  /**
 ...
 */
export type ArcGISSubLayer = __esri.Sublayer | __esri.KMLSublayer | __esri.WMSSublayer | __esri.WMTSSublayer
 ...
 */
export interface AbstractArcGISLayerFolderDataSource extends DataSource, JSAPILayerMixin, ItemMixin {
...
/**
 * `ImageServiceDataSource` is created from image service or webmap/webscene.
 * @ignore
 */
export interface ImageServiceDataSource extends DataSource, JSAPILayerMixin, ItemMixin {
  type: DataSourceTypes.ImageService
  layer?: __esri.ImageryLayer | __esri.ImageryTileLayer
}
...
export interface JSAPILayerMixin {
  ...
  itemId?: string
  portalUrl?: string
  createJSAPILayerByDataSource: () => Promise<__esri.Layer>
  // Whether the layer has spatial infomation to draw the layer to a map, such as latitude and longitude.
