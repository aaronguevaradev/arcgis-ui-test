...
import { React, IntlProvider, type IMState, ReactRedux, getAppStore, type I18nMessages, Immutable, type IMThemeVariables, SupportedJSAPILayerTypes } from 'jimu-core'
import { type Store } from 'redux'
import * as customQueries from './custom-queries'
import { type MockItemData } from './mock-item'

import mockTheme from './theme-mock'
import { ThemeProvider, getTheme, setThemeModule, type ThemeModule, ThemeStore } from 'jimu-theme'
