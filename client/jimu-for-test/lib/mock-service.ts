import { type ArcGISServerInfo, type ServiceDefinition, ServiceManager } from 'jimu-core'
import { type IQueryFeaturesResponse } from '@esri/arcgis-rest-feature-layer'
