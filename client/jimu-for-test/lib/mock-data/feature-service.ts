...
import { type MockFeatureLayerData, type MockServiceData } from '../mock-service'
...
export const featureLayer: MockFeatureLayerData = {
  ...
  queries: [{
    ...
    url: `${FEATURE_LAYER_URL}/query?f=json&where=1=1&outFields=*&returnGeometry=true&returnZ=true&resultRecordCount=100`,
    result: {
      fields: [],
      features: [{ attributes: {} }]
    }
