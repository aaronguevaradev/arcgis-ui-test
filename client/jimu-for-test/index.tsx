import {
  ...
  type AppRuntimeInfo, type UrlParameters, BrowserSizeMode, type AppContext, type JimuMapViewInfo, type RuntimeInfos, type WidgetsMutableStateVersion, type MapWidgetInfo, type IMAppConfig
} from 'jimu-core'
...
export function initGlobal () {
  window.jimuConfig = {
    ...
    hostEnv: 'prod',
    isDevEdition: false,
    arcgisJsApiUrl: 'https://js.arcgis.com/4.28/',
    buildNumber: '',
    exbVersion: '1.13.0'
  }
  mockSystemJs()
